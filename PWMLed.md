...
<p>We use the same LED from the previous section. If you already have it assembled to your Raspberry Pi, (and downloaded the <a href="projects/AdjustableLED.zip">AdjustableLED</a> project), you can go directly to the <a href="#code">Code</a> section of this tutorial.</p>
